...
# load model
case_name = "large"
MAIN_DIR = "/media/acsmil/Disk 1/acsmil/training_8November/ML_micro-main/3_predict"
ML_filename = "/media/acsmil/Disk 1/acsmil/training_8November/ML_micro-main/2_train/runs/LR0.0001_BS50_NE10_TS42000_VS5600/model_state_dict_9"
...
for i in range(0, max_t-skip, skip):
    ...
    if i % 1 == 0:
        ...
        np.save(os.path.join(MAIN_DIR, "test_images", f"test_image_{i+1}"), T0.astype(np.float32))
