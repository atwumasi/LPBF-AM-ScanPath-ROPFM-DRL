...
def np_perm():
    ...
    imagedir = "/media/acsmil/Disk 1/acsmil/final/ML_micro-main/2_train/data/val_images"
    maskdir = "/media/acsmil/Disk 1/acsmil/final/ML_micro-main/2_train/data/val_masks"
